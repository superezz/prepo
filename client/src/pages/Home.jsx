          ...
          <div className="text-center mb-28">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className="border-gray-300 border px-10 py-3 rounded-full hover:bg-gray-100 transition shadow-md"
              >
                View History
              </motion.button>
            </div>
          </div>
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:mb-28">
            {[
              {
